       ...
       <div className="Weather">
         <div className="todays_weather">
          <div className="top">
           ...
           <img className="icon" src ={`https://openweathermap.org/img/w/${props.icon}.png`} alt="icon" />
           <p><b>{props.date}</b></p>
         ...
         <img className="icon" src ={`https://openweathermap.org/img/w/${props.oneicon}.png`} alt="icon" />
            <h4>{props.onedate}</h4>
            <p><b>Temperature</b> {props.onetemperature} °C </p>
            <p><b>Wind</b> {props.onewind} m/s</p>
          </div>
          <div className="future_weather_box2">
          <img className="icon" src ={`https://openweathermap.org/img/w/${props.twoicon}.png`} alt="icon" />
            <h4>{props.twodate}</h4>
            <p><b>Temperature</b> {props.twotemperature} °C </p>
            <p><b>Wind</b> {props.twowind} m/s</p>
            </div>
            <div className="future_weather_box3">
            <img className="icon" src ={`https://openweathermap.org/img/w/${props.threeicon}.png`} alt="icon" />
            ...
            <img className="icon" src ={`https://openweathermap.org/img/w/${props.fouricon}.png`} alt="icon" />
